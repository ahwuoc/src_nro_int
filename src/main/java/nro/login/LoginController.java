...
public class LoginController {
     ...
     */
    public void handlePlayerData(Message ms) {
        try {
            // Read entire message as binary data
            byte[] data = ms.getData();
            System.out.println("[Rust] Received binary player data: " + data.length + " bytes");
            session.getService().onPlayerDataBinaryReceived(data);
        } catch (Exception e) {
